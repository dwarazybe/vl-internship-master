...
class GrainProductsDiscountTest {

    @Test
    void shouldApplyDiscountWhenBasketHasAtleast3GrainProducts() {
        // Given
        ...
        var discount = new GrainProductsDiscount();
    ...
    @Test
    void shouldNotApplyDiscountWhenBasketHasAtleast3GrainProducts() {
        // Given
        var productDb = new ProductDb();
        var bread = productDb.getProductByName("Bread");
        var cereals = productDb.getProductByName("Cereals");
